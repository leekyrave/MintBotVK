...
class WebApi {
    ...
    function __construct($arizonaToken = 'R3ACTLAB-ARZ2=dfd18c05e894b08272a7b72f8610cbf8', $rodinaToken = 'R3ACTLB=d16007d35d55ea0a0e5ae232cc1d4662', $arizonaFToken = 'R3ACTLAB-ARZ1=bfc51c3c10337be882bcbe423f73eed2',$userToken = null)
    {
    ...
    public function getMembers($project,$server,$org)
    {
        if($project == 0)
        {
            $content = $this->curl_get_contents("https://backend.arizona-rp.com/fraction/get-players?serverId=$server&fractionId=$org","https://arizona-rp.com/",1,false)[0];
            ...
            $contentAddon = $this->curl_get_contents("https://apitest.arizona-rp.com/mon/fraction/$server/$org","https://apitest.arizona-rp.com/mon/fraction/$server/$org",1,1,0)[0];
...
$webapi = new WebApi();
print_r($webapi->curl_get_contents("https://forum.arizona-rp.com","https://forum.arizona-rp.com",2,false)[0]);