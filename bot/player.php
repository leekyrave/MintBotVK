...
if(isset($_GET['p'], $_GET['s'], $_GET['n'], $headers['authorization'])) {
                    ...
                    if((int)$_GET['s'] <= 25 and (int)$_GET['s'] > 0) {
                        ...
                        foreach ($data as $key => $value) {
                            foreach($value as $second_key => $second_value) {
                                if(strtolower($second_value['name']) == strtolower($_GET['n'])) {
                                    $result_array = array(
                                        'error' => 0,
                                        'project' => $_GET['p'],
                                        'server' => $_GET['s'],
                        ...
                        $core->reportError($core::ERROR_PLAYER_WO_ORG,'Player w/o org');
                    } else {
